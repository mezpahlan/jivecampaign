...
public class CameronJive extends Jive<TwitterInput, TwitterOutput, InMemoryJiveTranslator> {
    ...
    @Inject
    public CameronJive(TwitterInputFactory twitterInputFactory, TwitterOutputFactory twitterOutputFactory, InMemoryJiveTranslatorFactory inMemoryJiveTranslatorFactory) {
