...
public class SturgeonJive extends Jive<TwitterInput, TwitterOutput, InMemoryJiveTranslator> {
    ...
    @Inject
    public SturgeonJive(TwitterInputFactory twitterInputFactory, TwitterOutputFactory twitterOutputFactory, InMemoryJiveTranslatorFactory inMemoryJiveTranslatorFactory) {
