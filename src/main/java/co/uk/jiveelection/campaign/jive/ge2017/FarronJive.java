...
public class FarronJive extends Jive<TwitterInput, TwitterOutput, InMemoryJiveTranslator> {
    ...
    @Inject
    public FarronJive(TwitterInputFactory twitterInputFactory, TwitterOutputFactory twitterOutputFactory, InMemoryJiveTranslatorFactory inMemoryJiveTranslatorFactory) {
