...
@Module
public class SturgeonModule {

    @Provides
    @Singleton
    public static SturgeonJive provideJive() {
        return new SturgeonJive(providesInputFactory(), providesOutputFactory(), TranslatorModule.providesInMemoryJiveTranslatorFactory());
    }
    ...
    public static TwitterInputFactory providesInputFactory() {
        return new TwitterInputFactory(SturgeonModule::provideRealName, SturgeonModule::providesTwitter, SturgeonModule::providesTwitterStream);
    }

    @Provides
    @Singleton
    public static TwitterOutputFactory providesOutputFactory() {
        return new TwitterOutputFactory(SturgeonModule::providesTwitter);
    }
}
