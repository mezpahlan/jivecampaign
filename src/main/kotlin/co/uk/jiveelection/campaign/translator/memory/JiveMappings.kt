...
internal class JiveMappings {
     ...
     */
    private fun addAtomic(key: String, value: String) {
        map["\\b$key\\b"] = value
    }
     ...
     *
     *
     * For example given: Italian -> greaser
     * Do: Italians -> greasers
     *
     * @param key   The item to be translated.
     * @param value The translation
     */
    private fun addLeftAtomic(key: String, value: String) {
        map["\\b$key"] = value
    }
     ...
     * @param value The translation
     */
    private fun addRightAtomic(key: String, value: String) {
        map["$key\\b"] = value
    }
     ...
     * @param value The translation
     */
    private fun addMapping(key: String, value: String) {
        map[key] = value
    }

    companion object {
        val instance = JiveMappings()
    }
}
