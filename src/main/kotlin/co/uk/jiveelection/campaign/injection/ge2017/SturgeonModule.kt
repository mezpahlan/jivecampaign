...
@Module
object SturgeonModule {

    @Provides
    @Singleton
    fun provideJive(): SturgeonJive {
        return SturgeonJive(providesInputFactory(), providesOutputFactory(), TranslatorModule.providesInMemoryJiveTranslatorFactory())
    }
