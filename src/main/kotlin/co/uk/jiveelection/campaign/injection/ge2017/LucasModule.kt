...
class LucasModule {
    ...
    @Provides
    @Singleton
    fun provideJive(inMemoryJiveTranslatorFactory: InMemoryJiveTranslatorFactory): LucasJive {
        return LucasJive(providesInputFactory(), providesOutputFactory(), inMemoryJiveTranslatorFactory)
    }
