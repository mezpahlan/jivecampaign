...
class FarronModule {
    ...
    @Provides
    @Singleton
    fun provideJive(inMemoryJiveTranslatorFactory: InMemoryJiveTranslatorFactory): FarronJive {
        return FarronJive(providesInputFactory(), providesOutputFactory(), inMemoryJiveTranslatorFactory)
    }
